(()=>{
'use strict';
if(window.__sortiesMobilePolishV2)return;window.__sortiesMobilePolishV2=true;
...
#sortiesAdmin .sfs-table tr{display:block!important;width:100%!important;border:1px solid #e2e9e5!important;border-radius:15px!important;background:#fff!important;padding:12px 13px!important;box-shadow:0 1px 0 rgba(8,47,34,.02)!important}
...
#sortiesAdmin .sfs-table td::before{content:attr(data-mobile-label);flex:0 0 34%;text-align:left;color:#7a8781;font-size:11px;font-weight:750!important}
#sortiesAdmin .sfs-table td[data-mobile-name="1"]{display:block!important;text-align:left!important;padding:2px 0 10px!important;font-size:16px!important;font-weight:850!important;color:#17382c!important}
#sortiesAdmin .sfs-table td[data-mobile-name="1"]::before{display:none!important}
#sortiesAdmin .sfs-table td[data-mobile-actions="1"]{display:flex!important;justify-content:flex-start!important;flex-wrap:wrap!important;gap:8px!important;padding-top:10px!important;text-align:left!important}
#sortiesAdmin .sfs-table td[data-mobile-actions="1"]::before{display:none!important}
#sortiesAdmin .sfs-table td[data-mobile-actions="1"] button{min-height:38px!important;padding:8px 11px!important;margin:0!important}
...
[data-sfx-cleanmenu]{min-height:44px!important;border-radius:11px!important;padding:10px 12px!important;justify-content:flex-start!important}
}
...
let pending=false;function run(){if(pending)return;pending=true;requestAnimationFrame(()=>{pending=false;css();placeDetailDelete();optimizeParticipants()})}
