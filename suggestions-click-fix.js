(()=>{
  ...
  function composer(btn){
    ...
    const suggestionId=document.querySelector(`#suggestionsApp .sugCard[data-id] b`)?.closest('.sugCard')?.dataset.id||'';
