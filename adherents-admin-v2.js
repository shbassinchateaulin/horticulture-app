...
function loadSortiesSafe(){
  ...
  const loadAttendance=()=>{if(document.getElementById('sortiesAttendanceFastV1')){loadWizard();return;}const f=document.createElement('script');f.id='sortiesAttendanceFastV1';f.src='./sorties-attendance-fast-v1.js?v=4';f.async=false;f.onload=loadWizard;f.onerror=loadWizard;document.head.appendChild(f)};
  const loadDetails=()=>{if(document.getElementById('sortiesDetailsPlusV1')){loadAttendance();return;}const d=document.createElement('script');d.id='sortiesDetailsPlusV1';d.src='./sorties-details-plus-v1.js?v=4';d.async=false;d.onload=loadAttendance;d.onerror=loadAttendance;document.head.appendChild(d)};
  const loadSimpleUi=()=>{if(document.getElementById('sortiesUiSimpleV1')){loadDetails();return;}const u=document.createElement('script');u.id='sortiesUiSimpleV1';u.src='./sorties-ui-simple-v1.js?v=2';u.async=false;u.onload=loadDetails;u.onerror=loadDetails;document.head.appendChild(u)};
  ...
  const loadAutoUi=()=>{if(document.getElementById('sortiesAutoUiV1')){loadEnhancements();return;}const a=document.createElement('script');a.id='sortiesAutoUiV1';a.src='./sorties-auto-ui-v1.js?v=2';a.async=false;a.onload=loadEnhancements;a.onerror=loadEnhancements;document.head.appendChild(a)};
  const startUi=()=>{if(document.getElementById('sortiesSafeV1'))return;const x=document.createElement('script');x.id='sortiesSafeV1';x.src='./sorties-safe-v1.js?v=4';x.async=false;x.onload=loadAutoUi;document.head.appendChild(x)};
  if(!document.getElementById('sortiesQrPolyfillV1')){const q=document.createElement('script');q.id='sortiesQrPolyfillV1';q.src='./sorties-qr-polyfill-v1.js?v=3';q.async=true;document.head.appendChild(q)}
  startUi();
