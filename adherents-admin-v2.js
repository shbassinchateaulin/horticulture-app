...
function loadSortiesSafe(){
  ...
  const loadSimpleUi=()=>{if(document.getElementById('sortiesUiSimpleV1'))return;const u=document.createElement('script');u.id='sortiesUiSimpleV1';u.src='./sorties-ui-simple-v1.js?v=1';u.async=false;document.head.appendChild(u)};
  const loadEnhancements=()=>{if(document.getElementById('sortiesEnhancementsV1')){loadSimpleUi();return;}const e=document.createElement('script');e.id='sortiesEnhancementsV1';e.src='./sorties-enhancements-v1.js?v=1';e.async=false;e.onload=loadSimpleUi;e.onerror=loadSimpleUi;document.head.appendChild(e)};
  ...
  const startUi=()=>{if(document.getElementById('sortiesSafeV1'))return;const x=document.createElement('script');x.id='sortiesSafeV1';x.src='./sorties-safe-v1.js?v=2';x.async=false;x.onload=loadAutoUi;document.head.appendChild(x)};
  ...
  const b=document.createElement('script');b.id='sortiesSharedBridgeV1';b.src='./sorties-shared-bridge-v1.js?v=2';b.async=false;b.onload=()=>Promise.resolve(window.HorticultureSortiesSharedReady).finally(startUi);b.onerror=startUi;document.head.appendChild(b);
}
