...
function loadSortiesSafe(){
  ...
  const loadFixes=()=>{if(document.getElementById('sortiesFixesV1'))return;const f=document.createElement('script');f.id='sortiesFixesV1';f.src='./sorties-fixes-v1.js?v=3';f.async=false;document.head.appendChild(f)};
