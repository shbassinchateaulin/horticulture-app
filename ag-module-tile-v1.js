...
function openAG(e){
 ...
 const open=window.HorticultureAG?.open;
 if(typeof open==='function'){open();return}
 setTimeout(()=>{if(typeof window.HorticultureAG?.open==='function')window.HorticultureAG.open()},120);
}
function wire(b){
 if(!b||b.dataset.agDirectOpen==='1')return;
 b.dataset.agDirectOpen='1';
