...
function loadDocumentsCenter(){if(document.getElementById('documentsCenterV2'))return;const s=document.createElement('script');s.id='documentsCenterV2';s.src='./documents-center-v1.js?v=2';s.async=false;document.head.appendChild(s)}
loadDocumentsCenter();
